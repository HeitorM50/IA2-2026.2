...
Classificadores lineares, como a regressão logística multinomial, estimam fronteiras de decisão diretamente sobre atributos fixos e oferecem uma referência simples para quantificar o valor acrescentado por representações não lineares \cite{goodfellow2016deep}.
