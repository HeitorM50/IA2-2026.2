...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{acuracia-validacao-epocas.pdf}
\caption{Acurácia de validação por época nas três sementes de cada modelo; cada curva termina quando a parada antecipada é acionada, e as escalas verticais específicas evidenciam a dinâmica intramodelo, portanto as amplitudes entre painéis não devem ser comparadas diretamente.}
\label{fig:acuracia-validacao}
\end{figure*}
...
A Figura~\ref{fig:acuracia-validacao} mostra que a ResNet18 atingiu cedo uma faixa estável de alta acurácia, enquanto a CNN convergiu com oscilações maiores e a regressão logística permaneceu mais instável e em patamar inferior.
